...
func init() {
	...
	utilruntime.Must(awss3v1beta1.AddToScheme(scheme))
...
func main() {
	...
	if region == "" {
		setupLog.Error(fmt.Errorf("region argument missing"), "unable to start manager")
		os.Exit(1)
	}
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:   "cfa76309.redradrat.xyz",
	})
	if err != nil {
