...
type BucketSpec struct {
	// ACL contains a "canned ACL" as a string.
	// https://docs.aws.amazon.com/AmazonS3/latest/dev/acl-overview.html#canned-acl
	//
	// Examples: "private", "public-read"
	ACL string `json:"acl"`

	// ObjectLock enables and disables object locking
	ObjectLock bool `json:"objectLock"`

	// Versioning enables and disables object versioning
	Versioning bool `json:"versioning"`

	// TransferAcceleration enables and disables transfer acceleration for this bucket
